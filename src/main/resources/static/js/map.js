      ...
      //  console.log("距离： "+distance+" dur: "+duration);
        $.ajax({
            ...
            success:function(result) {
                ...
                const icons_set = new Map ([
                    ["plane", "<a href=\"#\" title=\"Flight icons creat\
                                                            ed by Nuion - Flaticon\"><img src = \"../icon/flight.png\"></a>"],
                    ["light_rail_or_tram",`<a href="#" title="Tram icons created by Freepik - Flaticon">
                                                <img src="../icon/tram.png">
                                            </a>`],
                    ["driving", `<a href="#" title="Transportation icons created by Freepik - Flaticon">
                                                <img src="../icon/car.png">
                                            </a>`],
                    ["Bus", `<a href="#" title="Bus icons created by Freepik - Flaticon">
                                                <img src="../icon/bus.png">
                                            </a>`],
                    ["Walking",`<a href="#" title="Walking icons created by Freepik - Flaticon">
                                                <img src="../icon/walking.png">
                                            </a>`],
                    ['Bicycle',`<a href="#" title="Bike icons created by Freepik - Flaticon">
                                                <img src="../icon/bicycle.png">
                                            </a>`],
                    ['E-Scooter',`<a href="#" title="Kick scooter icons created by Smashicons - Flaticon">
                ...
                switch  (transportation) {
                    case "plane":
                        ...
                        $("#recommendation_prompt").html("<p>Based on the current travel distance, recommend you taking <strong>plane</strong> to travel</p>");
                        generate_flip_card("plane");
                        break;
                    case "light_rail_or_tram":
                        $("#recommendation").html(icons_set.get("light_rail_or_tram"));
                        $("#recommendation_prompt").html("<p>Based on the current travel distance, recommend you taking <strong>tram or train</strong> to travel</p>");
                        generate_flip_card("light_rail_or_tram");
                        break;
                    case "driving":
                        $("#recommendation").html(icons_set.get("driving"));
                        $("#recommendation_prompt").html("<p>Based on the current travel distance, recommend you taking <strong>car</strong> to travel</p>");
                        generate_flip_card("driving");
                        break;
                    case "Bus":
                        $("#recommendation").html(icons_set.get("Bus"));
                        $("#recommendation_prompt").html("<p>Based on the current travel distance, recommend you taking <strong>bus</strong> to travel</p>");
                        generate_flip_card("Bus");
                        break;
                    case "Walking":
                        $("#recommendation").html(icons_set.get("Walking"));
                        $("#recommendation_prompt").html("<p>Based on the current travel distance, recommend you taking <strong>walking</strong> to travel</p>");
                        generate_flip_card("Walking");
                        break;
                    case "Bicycle":
                        $("#recommendation").html(icons_set.get("Bicycle"));
                        $("#recommendation_prompt").html("<p>Based on the current travel distance, recommend you taking <strong>cycling</strong> to travel.</p>");
                        generate_flip_card("Bicycle");
                        break;
                    case "E-Scooter":
                        $("#recommendation").html(icons_set.get("E-Scooter"));
                        $("#recommendation_prompt").html("<p>Based on the current travel distance, recommend you taking <strong>e-scooter</strong> to travel.</p>");
                ...
                //     }
                // });
                $("#distance").text("The distance is: " + distance + "m");
        ...
        $.ajax({
            ...
            success:function(resultNum) {
                ...
                var ylabels = ["plane","driving","E-Scooter","Bus","light rail","Bicycle","Walking"];
                var margin = 30;
                ...
                const icon_axis = ['\uf072','\uf1b9','\uf7c5','\uf207','\uf238','\uf206','\uf183'];
                const color_pallete = ['#8dd3c7','#ffffb3','#bebada','#fb8072','#80b1d3','#fdb462','#b3de69']
...
function generate_flip_card(transportation_) {
    ...
    $('.text-link').html(`<a href='/PageController/to${transportation}'><h4>`+transportation+`</h4></a>`);
}
